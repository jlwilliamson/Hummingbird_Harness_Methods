...
FigureS5 <- ggplot(data=sl, aes(x=common_name, y=phi)) + 
...
print(FigureS5)
ggsave(FigureS5, filename="FigureS5_LiteratureReviewPointEstimates_04-15-21.pdf", height=7, width=9, units="in")
